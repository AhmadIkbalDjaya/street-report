...
export default function Edit({ account, provinces, regencies }) {
    ...
    const [formValues, setFormValues] = useState({
        ...
        province_id: account.data.province_id,
        regency_id: account.data.regency_id,
        _method: "PUT",
    });
    ...
    function handleSubmitForm(e) {
        router.post(
            route("admin.account.update", { account: account.data.id }),
            formValues
        );
    }
    return (
        <>
            ...
            <BaseLayout>
                ...
                <div className="flex justify-between items-center mb-4">
                    <h2 className="font-medium text-xl">Edit Akun</h2>
                    <button
